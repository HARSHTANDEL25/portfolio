...
const SOCIAL_LINKS = [
    { icon: GitHubIcon, href: "https://github.com/HARSHTANDEL25", label: "GitHub" },
    { icon: TwitterIcon, href: "https://twitter.com/HARSHTANDEL25", label: "Twitter" },
];
...
export default function Footer() {
    ...
    return (
        ...
        >
            ...
            <div
                className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 h-px w-1/2 opacity-40"
            ...
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <p className="text-xs text-gray-600">© {year} Harsh Tandel. All rights reserved.</p>
            </div>
        </footer>
    );
}
